...
internal static class AssemblyLoader
{
	...
	static AssemblyLoader()
	{
		...
		assemblyNames.Add("fluorinefx", "costura.fluorinefx.dll.compressed");
		assemblyNames.Add("guna.ui", "costura.guna.ui.dll.compressed");
		assemblyNames.Add("log4net", "costura.log4net.dll.compressed");
		assemblyNames.Add("materialskin", "costura.materialskin.dll.compressed");
